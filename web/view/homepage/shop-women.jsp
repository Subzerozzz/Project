<%-- 
    Document   : shop-women.jsp
    Created on : Mar 3, 2025, 2:59:59 PM
    Author     : User
--%>
...
<!-- Mirrored from themesflat.co/html/ecomus/shop-women.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 03:22:10 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="preload-wrapper">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="tf-list-layout wrapper-shop" id="listLayout">
                        ...
                        <div class="card-product list-layout" data-availability="Out of stock" data-brand="M&H">
                            <div class="card-product-wrapper">
                                <div class="product-img">
                                    <img class="lazyload img-product" data-src="${pageContext.request.contextPath}/images/products/white-8.jpg" src="${pageContext.request.contextPath}/images/products/white-8.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="${pageContext.request.contextPath}/images/products/black-6.jpg" src="${pageContext.request.contextPath}/images/products/black-6.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="tooltip">White</span>
                                        <span class="swatch-value bg_white"></span>
                                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/products/white-8.jpg" src="${pageContext.request.contextPath}/images/products/white-8.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Black</span>
                                        <span class="swatch-value bg_dark"></span>
                                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/products/black-7.jpg" src="${pageContext.request.contextPath}/images/products/black-7.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="tooltip">Blue</span>
                                        <span class="swatch-value bg_blue-2"></span>
                                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/products/blue-2.jpg" src="${pageContext.request.contextPath}/images/products/blue-2.jpg" alt="image-product">
                                    </li>
                                </ul>
                                <div class="size-list">
                                    <span class="size-item">S</span>
                    ...
                    <div class="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
                        <c:forEach items="${listWomen}" var="item">
                            <!-- card product  -->
                            <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                                ...
                                <div class="card-product-info">
                                    ...
                                    <span class="price current-price">$${item.getPrice()}</span>
                                </div>
                            </div>
                        </c:forEach>
                        <!--pagination-->
                        <ul class=" tf-pagination-list">
                            <c:forEach begin="1" end="${pageControlWomen.totalPage}" var="pageNumber">
                                <li class="">
                                    <a href="${pageControlWomen.urlPattern}page=${pageNumber}" class="pagination-link">${pageNumber}</a>
                                </li>
                            </c:forEach>
                            <li>
                    ...
                    <div class="widget-facet">
                        ...
                        <div id="brand" class="collapse show">
                            <ul class="tf-filter-group current-scrollbar mb_36">
                                ...
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="brand" class="tf-check" id="M">
                                    <label for="M" class="label"><span>M&H</span>&nbsp;<span>(8)</span></label>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/nouislider.min.js"></script>
