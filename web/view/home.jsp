<%-- 
    Document   : home
    Created on : Feb 21, 2025, 10:54:04 PM
    Author     : User
--%>
...
<!-- Mirrored from themesflat.co/html/ecomus/home-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 03:12:27 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="top-bar-language tf-cur justify-content-end">
                        ...
                        <div class="tf-currencies">
                            <select class="image-select center style-default type-currencies">
                                <option data-thumbnail="${pageContext.request.contextPath}/images/country/fr.svg">EUR <span>€ | France</span></option>
                                <option data-thumbnail="${pageContext.request.contextPath}/images/country/de.svg">EUR <span>€ | Germany</span></option>
                                <option selected data-thumbnail="${pageContext.request.contextPath}/images/country/us.svg">USD <span>$ | United States</span></option>
                                <option data-thumbnail="${pageContext.request.contextPath}/images/country/vn.svg">VND <span>₫ | Vietnam</span></option>
                            </select>
                        </div>
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="index.html" class="logo-header">
                            <img src="${pageContext.request.contextPath}/images/logo/logo.svg" alt="logo" class="logo">
                        </a>
                    </div>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-1.jpg" src="${pageContext.request.contextPath}/images/collections/collection-1.jpg" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-2.jpg" src="${pageContext.request.contextPath}/images/collections/collection-2.jpg" alt="collection-demo-1">
                                                            </a>
                                                            <div class="collection-content">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="${pageContext.request.contextPath}/images/products/brown-2.jpg" src="${pageContext.request.contextPath}/images/products/brown-2.jpg" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="${pageContext.request.contextPath}/images/products/brown-3.jpg" src="${pageContext.request.contextPath}/images/products/brown-3.jpg" alt="image-product">
                                                                            </div>
                                                                            <div class="size-list">
                                                                                <span>S</span>
                                                                                <span>M</span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/products/brown-2.jpg" src="${pageContext.request.contextPath}/images/products/brown-2.jpg" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/products/white-5.jpg" src="${pageContext.request.contextPath}/images/products/white-5.jpg" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-04.jpg" src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-04.jpg" alt="fashion-slideshow-01">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-05.jpg" src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-05.jpg" alt="fashion-slideshow-02">
                            <div class="box-content">
                                <div class="container">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-06.jpg" src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-06.jpg" alt="fashion-slideshow-03">
                            <div class="box-content">
                                <div class="container">
            ...
            <div class="container-full">
                <div class="masonry-layout wow fadeInUp">
                    <div class="item-1 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="shop-women.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-21.jpg" src="${pageContext.request.contextPath}/images/collections/collection-21.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-2 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-22.jpg" src="${pageContext.request.contextPath}/images/collections/collection-22.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-3 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-23.jpg" src="${pageContext.request.contextPath}/images/collections/collection-23.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-4 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="shop-men.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-24.jpg" src="${pageContext.request.contextPath}/images/collections/collection-24.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text">
                    <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/collections/collection-25.jpg" src="${pageContext.request.contextPath}/images/collections/collection-25.jpg" alt="collection-img">
                    </div>
                    ...
                    <div dir="ltr" class="swiper tf-sw-collection" data-preview="2" data-tablet="2" data-mobile="1" data-space-lg="30" data-space-md="30" data-space="15" data-loop="false" data-auto-play="false">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="banner-gr-item text-center hover-img">
                                    <a href="shop-default.html" class="img-style">
                                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/file/banner-gr-1.jpg" src="${pageContext.request.contextPath}/images/shop/file/banner-gr-1.jpg" alt="banner-collection">
                                    </a>
                                    <div class="content">
                                        <div class="title">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="banner-gr-item text-center hover-img">
                                    <a href="shop-default.html" class="img-style">
                                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/file/banner-gr-2.jpg" src="${pageContext.request.contextPath}/images/shop/file/banner-gr-2.jpg" alt="banner-collection">
                                    </a>
                                    <div class="content">
                                        <div class="title">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="hongkong" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/store/ourstore1.png" src="${pageContext.request.contextPath}/images/shop/store/ourstore1.png" alt="store-img">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="london" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/store/ourstore2.png" src="${pageContext.request.contextPath}/images/shop/store/ourstore2.png" alt="store-img">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="paris" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/store/ourstore3.png" src="${pageContext.request.contextPath}/images/shop/store/ourstore3.png" alt="store-img">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row-brand">
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-01.png" src="${pageContext.request.contextPath}/images/brand/brand-01.png"  alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-02.png" src="${pageContext.request.contextPath}/images/brand/brand-02.png"  alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-03.png" src="${pageContext.request.contextPath}/images/brand/brand-03.png"  alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-04.png" src="${pageContext.request.contextPath}/images/brand/brand-04.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-05.png" src="${pageContext.request.contextPath}/images/brand/brand-05.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-06.png" src="${pageContext.request.contextPath}/images/brand/brand-06.png" alt="image-brand">
                    </div>
                </div>        
            </div>
        </section>
...
<!-- Mirrored from themesflat.co/html/ecomus/home-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 03:16:55 GMT -->
</html>
