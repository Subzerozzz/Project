            ...
            <div class="col-xl-6 tf-md-hidden">
                <nav class="box-navigation text-center">
                    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                        <li class="menu-item">
                            <a href="home?action=home" class="item-link">Home<i class="icon icon-arrow-down"></i></a>
                            ...
                            <div class="sub-menu mega-menu">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="mega-menu-item">
                                                <div class="menu-heading">Womens</div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="home?action=men" class="collection-image img-style">
                                                    ...
                                                    <div class="collection-content">
                                                        <a href="home?action=men" class="tf-btn hover-icon btn-xl collection-title fs-16"><span>Men</span><i class="icon icon-arrow1-top-left"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="home?action=women" class="collection-image img-style">
                                                    ...
                                                    <div class="collection-content">
                                                        <a href="home?action=women" class="tf-btn btn-xl collection-title fs-16 hover-icon"><span>Women</span><i class="icon icon-arrow1-top-left"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
