<%-- 
    Document   : shop-men
    Created on : Mar 3, 2025, 2:28:01 PM
    Author     : User
--%>
...
<!-- Mirrored from themesflat.co/html/ecomus/shop-men.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 03:22:10 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
                        ...
                        <c:forEach items="${listMen}" var="item">
                            <!-- card product  -->
                        ...
                        <ul class=" tf-pagination-list">
                            ...
                            <c:forEach begin="1" end="${pageControlMen.totalPage}" var="pageNumber">
                                <li class="">
                                    <a href="${pageControlMen.urlPattern}page=${pageNumber}" class="pagination-link">${pageNumber}</a>
                                </li>
                            </c:forEach>
                            <li>
