...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        <!-- Top bar -->
        <jsp:include page="../common/homePage/top-bar.jsp"></jsp:include>
        <!-- /Top bar -->
        <!-- Header -->
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload"
                                data-src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-04.jpg"
                                src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-04.jpg"
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload"
                                data-src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-05.jpg"
                                src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-05.jpg"
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload"
                                data-src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-06.jpg"
                                src="${pageContext.request.contextPath}/images/slider/fashion-slideshow-06.jpg"
                ...
                <div class="masonry-layout wow fadeInUp">
                    <div class="item-1 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="home?action=women" class="collection-image img-style rounded-0">
                                <img class="lazyload"
                                    data-src="${pageContext.request.contextPath}/images/collections/collection-21.jpg"
                                    src="${pageContext.request.contextPath}/images/collections/collection-21.jpg"
                                    alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="home?action=women"
                                    class="tf-btn collection-title hover-icon"><span>Women</span><i
                    ...
                    <div class="item-2 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style rounded-0">
                                <img class="lazyload"
                                    data-src="${pageContext.request.contextPath}/images/collections/collection-22.jpg"
                                    src="${pageContext.request.contextPath}/images/collections/collection-22.jpg"
                                    alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html"
                                    class="tf-btn collection-title hover-icon"><span>Handbag</span><i
                                        class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-3 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style rounded-0">
                                <img class="lazyload"
                                    data-src="${pageContext.request.contextPath}/images/collections/collection-23.jpg"
                                    src="${pageContext.request.contextPath}/images/collections/collection-23.jpg"
                                    alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html"
                                    class="tf-btn collection-title hover-icon"><span>Accessories</span><i
                                        class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-4 collection-item large hover-img">
                        <div class="collection-inner">
                            <a href="home?action=men" class="collection-image img-style rounded-0">
                                <img class="lazyload"
                                    data-src="${pageContext.request.contextPath}/images/collections/collection-24.jpg"
                                    src="${pageContext.request.contextPath}/images/collections/collection-24.jpg"
                                    alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="home?action=men" class="tf-btn collection-title hover-icon"><span>Men</span><i
                                        class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text">
                    <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                        <img class="lazyload"
                            data-src="${pageContext.request.contextPath}/images/collections/collection-25.jpg"
                            src="${pageContext.request.contextPath}/images/collections/collection-25.jpg"
                            alt="collection-img">
                    </div>
                    <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                        ...
                        <p class="description">Discover the versatility of denim with our collection of jeans, jackets
                        </p>
            ...
            <div class="container">
                <div class="flat-title flex-row justify-content-between px-0">
                    ...
                    <div class="box-sw-navigation">
                        <div class="nav-sw square nav-next-slider nav-next-product"><span
                                class="icon icon-arrow1-left"></span></div>
                        <div class="nav-sw square nav-prev-slider nav-prev-product"><span
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="card-product style-2">
                                        <div class="card-product-wrapper">
                                            <a href="product_details?id=${item.product_id}" class="product-img">
                                                <img class="lazyload img-product" data-src="${item.getImage()}" src="${item.getImage()}" alt="image-product">
                                                <img class="lazyload img-hover" data-src="${item.getImage()}" src="${item.getImage()}" alt="image-product">
                                            </a>
                                        ...
                                        <div class="card-product-info">
                                            <a href="product_details?id=${item.product_id}" class="title link">${item.getName()}</a>
                                            <span class="price">From $${item.getPrice()}</span>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
        ...
        <section class="flat-spacing-3 pt_0 line">
            <div class="container-full">
                <div class="wrap-carousel">
                    <div dir="ltr" class="swiper tf-sw-collection" data-preview="2" data-tablet="2" data-mobile="1"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="banner-gr-item text-center hover-img">
                                    <a href="shop-default.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="${pageContext.request.contextPath}/images/shop/file/banner-gr-1.jpg"
                                            src="${pageContext.request.contextPath}/images/shop/file/banner-gr-1.jpg"
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="shop-default.html" class="tf-btn btn-line">Shop Collection<i
                                                class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide" lazy="true">
                                <div class="banner-gr-item text-center hover-img">
                                    <a href="shop-default.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="${pageContext.request.contextPath}/images/shop/file/banner-gr-2.jpg"
                                            src="${pageContext.request.contextPath}/images/shop/file/banner-gr-2.jpg"
                                            alt="banner-collection">
                                    </a>
                                    <div class="content">
                                        <div class="title">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="hongkong" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/shop/store/ourstore1.png"
                                        src="${pageContext.request.contextPath}/images/shop/store/ourstore1.png"
                                        alt="store-img">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="london" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/shop/store/ourstore2.png"
                                        src="${pageContext.request.contextPath}/images/shop/store/ourstore2.png"
                                        alt="store-img">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="paris" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/shop/store/ourstore3.png"
                                        src="${pageContext.request.contextPath}/images/shop/store/ourstore3.png"
                                        alt="store-img">
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row-brand">
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-01.png"
                            src="${pageContext.request.contextPath}/images/brand/brand-01.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-02.png"
                            src="${pageContext.request.contextPath}/images/brand/brand-02.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-03.png"
                            src="${pageContext.request.contextPath}/images/brand/brand-03.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-04.png"
                            src="${pageContext.request.contextPath}/images/brand/brand-04.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-05.png"
                            src="${pageContext.request.contextPath}/images/brand/brand-05.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="${pageContext.request.contextPath}/images/brand/brand-06.png"
                            src="${pageContext.request.contextPath}/images/brand/brand-06.png" alt="image-brand">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-01.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-01.jpg" alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-multi-brand.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-multi-brand.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-02.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-02.jpg" alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-03.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-03.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-03.jpg" alt="home-03">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-04.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-04.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-04.jpg" alt="home-04">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-05.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-05.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-05.jpg" alt="home-05">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-06.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-06.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-06.jpg" alt="home-06">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-personalized-pod.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-personalized-pod.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-personalized-pod.jpg"
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-pickleball.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-pickleball.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-pickleball.png"
                                        alt="home-pickleball">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-ceramic.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-ceramic.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-ceramic.png"
                                        alt="home-ceramic">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-food.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-food.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-food.png"
                                        alt="home-food">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-camp-and-hike.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-camp-and-hike.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-camp-and-hike.png"
                        ...
                        <div class="demo-item">
                            <a href="home-07.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-07.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-07.jpg" alt="home-07">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-08.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-08.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-08.jpg" alt="home-08">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-skincare.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-skincare.jpg"
                                        alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-headphone.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-headphone.jpg"
                                        alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-giftcard.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-giftcard.jpg"
                                        alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-furniture.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-furniture.jpg"
                                        alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-furniture2.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-furniture2.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-skateboard.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-skateboard.jpg"
                                        alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-stroller.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-stroller.jpg"
                                        alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-decor.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-decor.jpg"
                                        alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-electronic.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-electronic.jpg"
                                        alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-setup-gear.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-setup-gear.jpg"
                                        alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-dog-accessories.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-dog-accessories.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-kitchen.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-kitchen.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-phonecase.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-phonecase.jpg"
                                        alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home_paddle_board.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home_paddle_board.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-glasses.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-glasses.jpg"
                                        alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-pod-store.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-pod-store.jpg"
                                        alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-activewear.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-activewear.jpg"
                                        alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-handbag.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-handbag.jpg"
                                        alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-tee.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-tee.jpg"
                                        alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-socks.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-socks.jpg"
                                        alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-jewelry.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-jewelry.jpg"
                                        alt="home-jewelry">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-sneaker.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-sneaker.jpg"
                                        alt="home-sneaker">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-accessories.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-accessories.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-grocery.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-gocery.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-gocery.jpg"
                                        alt="home-grocery">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-baby.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-baby.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-baby.jpg"
                                        alt="home-baby">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-cosmetic.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-cosmetic.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-cosmetic.png"
                                        alt="home-cosmetic">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-plant.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-plant.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-plant.png"
                                        alt="home-plant">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-swimwear.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-swimwear.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-swimwear.png"
                                        alt="home-swimwear">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electric-bike.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-electric-bike.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-electric-bike.png"
                        ...
                        <div class="demo-item">
                            <a href="home-footwear.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-footwear.jpg"
                                        src="${pageContext.request.contextPath}/images/demo/home-footwear.jpg"
                                        alt="home-footwear">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-book-store.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-bookstore.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-bookstore.png"
                                        alt="home-bookstore">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-gaming-accessories.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="${pageContext.request.contextPath}/images/demo/home-gaming-accessories.png"
                                        src="${pageContext.request.contextPath}/images/demo/home-gaming-accessories.png"
                ...
                <div class="bottom-bar-language">
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option data-thumbnail="${pageContext.request.contextPath}/images/country/fr.svg">EUR
                                <span>€ | France</span></option>
                            <option data-thumbnail="${pageContext.request.contextPath}/images/country/de.svg">EUR
                                <span>€ | Germany</span></option>
                            <option selected data-thumbnail="${pageContext.request.contextPath}/images/country/us.svg">
                                USD <span>$ | United States</span></option>
                            <option data-thumbnail="${pageContext.request.contextPath}/images/country/vn.svg">VND
                                <span>₫ | Vietnam</span></option>
                        </select>
                    </div>
                            ...
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="#cate-shop-one"
                                        ...
                                        <div class="image">
                                            <img src="${pageContext.request.contextPath}/images/shop/cate/cate6.jpg"
                                                alt="">
                                        </div>
                                        <span>Mens</span>
                                        <span class="btn-open-sub"></span>
                                        ...
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/shop/cate/cate1.jpg"
                                                            alt="">
                                                    </div>
                                                    <span>Accessories</span>
                                                </a>
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/shop/cate/cate8.jpg"
                                                            alt="">
                                                    </div>
                                                    <span>Shoes</span>
                                                </a>
                                ...
                                <li>
                                    <a href="#cate-shop-two"
                                        ...
                                        <div class="image">
                                            <img src="${pageContext.request.contextPath}/images/shop/cate/cate9.jpg"
                                                alt="">
                                        </div>
                                        <span>Womens</span>
                                        <span class="btn-open-sub"></span>
                                    ...
                                    <div id="cate-shop-two" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/shop/cate/cate4.png"
                                                            alt="">
                                                    </div>
                                                    <span>Handbag</span>
                                                </a>
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/shop/cate/cate7.jpg"
                                                            alt="">
                                                    </div>
                                                    <span>Tee</span>
                                                </a>
                            ...
                            <div class="tf-mini-cart-sroll">
                                <div class="tf-mini-cart-items">
                                    <div class="tf-mini-cart-item">
                                        <div class="tf-mini-cart-image">
                                            <a href="product-detail.html">
                                                <img src="${pageContext.request.contextPath}/images/products/white-2.jpg"
                                                    alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="tf-mini-cart-item">
                                        <div class="tf-mini-cart-image">
                                            <a href="product-detail.html">
                                                <img src="${pageContext.request.contextPath}/images/products/white-3.jpg"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="tf-mini-cart-info">
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3"
                                                    src="${pageContext.request.contextPath}/images/products/orange-1.jpg"
                                                    alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3"
                                                    src="${pageContext.request.contextPath}/images/products/pink-1.jpg"
                                                    alt="">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <form class="">
                            ...
                            <div class="w-100">
                                <a href="#" class="btns-full">Buy with <img
                                        src="${pageContext.request.contextPath}/images/payments/paypal.png" alt=""></a>
                    ...
                    <div class="tf-product-media-wrap">
                        <div dir="ltr" class="swiper tf-single-slide">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="${pageContext.request.contextPath}/images/products/orange-1.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                        ...
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <div class="w-100">
                                        <a href="#" class="btns-full">Buy with <img
                                                src="${pageContext.request.contextPath}/images/payments/paypal.png"
                                                alt=""></a>
                                        <a href="#" class="payment-more-option">More payment options</a>
                                    </div>
                                </form>
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload"
                                data-src="${pageContext.request.contextPath}/images/shop/products/size_chart2.jpg"
                                src="${pageContext.request.contextPath}/images/shop/products/size_chart2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
