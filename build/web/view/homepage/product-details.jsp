                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form action="payment?action=add" method="POST">
                                            <input type="hidden" name="id" value="${productDetail.product_id}"/>
                                            <input type="hidden" class="quantity-product" name="quantity" value="1">
                                            <div onclick=" return this.closest('form').submit();" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn">
                                                <span>Add to cart -&nbsp;</span>
                                                <span name="total-price" class="tf-qty-price total-price">$${productDetail.getPrice()}</span>
                                            </div>
