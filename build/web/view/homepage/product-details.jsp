<%-- 
    ...
    Created on : Mar 4, 2025, 7:22:19 PM
    Author     : User
--%>
...
<!-- Mirrored from themesflat.co/html/ecomus/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 03:22:10 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/drift-basic.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/photoswipe.css">
...
<body class="preload-wrapper">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="beige">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${productDetail.getImage()}" src="${productDetail.getImage()}" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="beige">
                                                <div class="item">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="black">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod8.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod8.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="black">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod9.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod9.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- blue -->
                                            <div class="swiper-slide stagger-item" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod10.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod10.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod11.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod11.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod12.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod12.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod13.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod13.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- white -->
                                            <div class="swiper-slide stagger-item" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod14.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod14.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod15.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod15.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod16.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod16.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod17.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod17.jpg" alt="img-product">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper" >
                                            ...
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="${productDetail.getImage()}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod31.jpg" data-src="${productDetail.getImage()}" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod31.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="images/shop/products/hmgoepprod.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod.jpg" data-src="${productDetail.getImage()}" src="${productDetail.getImage()}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="images/shop/products/hmgoepprod2.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod2.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod2.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod2.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="images/shop/products/hmgoepprod3.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod3.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod3.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod3.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="images/shop/products/hmgoepprod4.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod4.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod4.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod4.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="images/shop/products/hmgoepprod5.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod5.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod5.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod5.jpg" alt="">
                                                </a>
                                            </div>
                                             <!-- black -->
                                            <div class="swiper-slide" data-color="black">
                                                <a href="images/shop/products/hmgoepprod6.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod6.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod6.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod6.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="black">
                                                <a href="images/shop/products/hmgoepprod7.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod7.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod7.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod7.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="black">
                                                <a href="images/shop/products/hmgoepprod8.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod8.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod8.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod8.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="black">
                                                <a href="images/shop/products/hmgoepprod9.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                     <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod9.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod9.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod9.jpg" alt="">
                                                </a>
                                            </div>
                                            <!-- blue -->
                                            <div class="swiper-slide" data-color="blue">
                                                <a href="images/shop/products/hmgoepprod10.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod10.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod10.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod10.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="blue">
                                                <a href="images/shop/products/hmgoepprod11.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod11.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod11.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod11.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="blue">
                                                <a href="images/shop/products/hmgoepprod12.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod12.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod12.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod12.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="blue">
                                                <a href="images/shop/products/hmgoepprod13.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                     <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod13.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod13.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod13.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- white -->
                                            <div class="swiper-slide" data-color="white">
                                                <a href="images/shop/products/hmgoepprod14.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod14.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod14.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod14.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="white">
                                                <a href="images/shop/products/hmgoepprod15.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod15.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod15.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod15.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="white">
                                                <a href="images/shop/products/hmgoepprod16.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod16.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod16.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod16.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <div class="swiper-slide" data-color="white">
                                                <a href="images/shop/products/hmgoepprod17.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                     <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod17.jpg" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod17.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod17.jpg" alt="img-product">
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-price">
                                        <div class="price-on-sale">$${productDetail.getPrice()}</div>
                                    </div>
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price total-price">$${productDetail.getPrice()}</span></a>
                                            ...
                                            <div class="w-100">
                                                <a href="#" class="btns-full">Buy with <img src="${pageContext.request.contextPath}/images/payments/paypal.png" alt=""></a>
                                    ...
                                    <div class="tf-product-info-extra-link">
                                        <a href="#compare_color" data-bs-toggle="modal" class="tf-product-extra-icon">
                                            <div class="icon">
                                                <img src="${pageContext.request.contextPath}/images/item/compare.svg" alt="">
                                            </div>
                                    ...
                                    <div class="tf-product-info-trust-seal">
                                        ...
                                        <div class="tf-payment">
                                            <img src="${pageContext.request.contextPath}/images/payments/visa.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/payments/img-1.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/payments/img-2.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/payments/img-3.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/payments/img-4.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tf-height-observer w-100 d-flex align-items-center">
                        <div class="tf-sticky-atc-product d-flex align-items-center">
                            <div class="tf-sticky-atc-img">
                                <img class="lazyloaded" data-src="${productDetail.getImage()}" alt="" src="${productDetail.getImage()}">
                            </div>
                            <div class="tf-sticky-atc-title fw-5 d-xl-block d-none">${productDetail.getName()}</div>
                        </div>
                        <div class="tf-sticky-atc-infos">
                            <form class="">
                                <div class="tf-sticky-atc-variant-price text-center">
                                    <select class="tf-select">
                                        <option selected="selected">Beige / S - ${productDetail.getPrice()}</option>
                                        <option>Beige / M - $${productDetail.getPrice()}</option>
                                        <option>Beige / L - $${productDetail.getPrice()}</option>
                                        <option>Beige / XL - $${productDetail.getPrice()}</option>
                                        <option>Black / S - $${productDetail.getPrice()}</option>
                                        <option>Black / M - $${productDetail.getPrice()}</option>
                                        <option>Black / L - $${productDetail.getPrice()}</option>
                                        <option>Black / XL - $${productDetail.getPrice()}</option>
                                        <option>Blue / S - $${productDetail.getPrice()}</option>
                                        <option>Blue / M - $${productDetail.getPrice()}</option>
                                        <option>Blue / L - $${productDetail.getPrice()}</option>
                                        <option>Blue / XL - $${productDetail.getPrice()}</option>
                                        <option>White / S - $${productDetail.getPrice()}</option>
                                        <option>White / M - $${productDetail.getPrice()}</option>
                                        <option>White / L - $${productDetail.getPrice()}</option>
                                        <option>White / XL - $${productDetail.getPrice()}</option>
                                    </select>
                                </div>
                                        ...
                                        <div class="reply-comment cancel-review-wrap">
                                            ...
                                            <div class="reply-comment-wrap">
                                                <div class="reply-comment-item">
                                                    <div class="user">
                                                        <div class="image">
                                                            <img src="${pageContext.request.contextPath}/images/collections/collection-circle-9.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <h6>
                                                ...
                                                <div class="reply-comment-item type-reply">
                                                    <div class="user">
                                                        <div class="image">
                                                            <img src="${pageContext.request.contextPath}/images/collections/collection-circle-10.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <h6>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="${pageContext.request.contextPath}/images/logo/logo.svg" alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                    ...
                    <div class="tf-compare-color-grid">
                        ...
                        <div class="tf-compare-color-item">
                            <div class="tf-compare-color-top">
                                ...
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod2.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod2.jpg" alt="img-compare">
                            </div>
                            <div class="tf-compare-color-bottom">
                                ...
                                <form class="">
                                    <select class="tf-select" name="id">
                                        <option value="46633906045232" selected="">S - $${productDetail.getPrice()}</option>
                                        <option value="47256262738224">M - $${productDetail.getPrice()}</option>
                                        <option value="47256262770992">L - $${productDetail.getPrice()}</option>
                                        <option value="47256262803760">XL - $${productDetail.getPrice()}</option>
                                    </select>
                        ...
                        <div class="tf-compare-color-item">
                            <div class="tf-compare-color-top">
                                ...
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod12.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod12.jpg" alt="">
                            </div>
                            <div class="tf-compare-color-bottom">
                                <div class="tf-compare-color-color">
                        ...
                        <div class="tf-compare-color-item">
                            <div class="tf-compare-color-top">
                                ...
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod7.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod7.jpg" alt="">
                            </div>
                            <div class="tf-compare-color-bottom">
                                <div class="tf-compare-color-color">
                        ...
                        <div class="tf-compare-color-item">
                            <div class="tf-compare-color-top">
                                ...
                                <img class="lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod14.jpg" src="${pageContext.request.contextPath}/images/shop/products/hmgoepprod14.jpg" alt="">
                            </div>
                            <div class="tf-compare-color-bottom">
                                <div class="tf-compare-color-color">
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-01.jpg" src="${pageContext.request.contextPath}/images/demo/home-01.jpg" alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-multi-brand.jpg" src="${pageContext.request.contextPath}/images/demo/home-multi-brand.jpg" alt="home-multi-brand">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-02.jpg" src="${pageContext.request.contextPath}/images/demo/home-02.jpg" alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-03.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-03.jpg" src="${pageContext.request.contextPath}/images/demo/home-03.jpg" alt="home-03">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-04.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-04.jpg" src="${pageContext.request.contextPath}/images/demo/home-04.jpg" alt="home-04">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-05.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-05.jpg" src="${pageContext.request.contextPath}/images/demo/home-05.jpg" alt="home-05">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-06.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-06.jpg" src="${pageContext.request.contextPath}/images/demo/home-06.jpg" alt="home-06">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-personalized-pod.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-personalized-pod.jpg" src="${pageContext.request.contextPath}/images/demo/home-personalized-pod.jpg" alt="home-personalized-pod">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-pickleball.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-pickleball.png" src="${pageContext.request.contextPath}/images/demo/home-pickleball.png" alt="home-pickleball">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-ceramic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-ceramic.png" src="${pageContext.request.contextPath}/images/demo/home-ceramic.png" alt="home-ceramic">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-food.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-food.png" src="${pageContext.request.contextPath}/images/demo/home-food.png" alt="home-food">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-camp-and-hike.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-camp-and-hike.png" src="${pageContext.request.contextPath}/images/demo/home-camp-and-hike.png" alt="home-camp-and-hike">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-07.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-07.jpg" src="${pageContext.request.contextPath}/images/demo/home-07.jpg" alt="home-07">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-08.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-08.jpg" src="${pageContext.request.contextPath}/images/demo/home-08.jpg" alt="home-08">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-skincare.jpg" src="${pageContext.request.contextPath}/images/demo/home-skincare.jpg" alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-headphone.jpg" src="${pageContext.request.contextPath}/images/demo/home-headphone.jpg" alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-giftcard.jpg" src="${pageContext.request.contextPath}/images/demo/home-giftcard.jpg" alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-furniture.jpg" src="${pageContext.request.contextPath}/images/demo/home-furniture.jpg" alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-furniture2.jpg" src="${pageContext.request.contextPath}/images/demo/home-furniture2.jpg" alt="home-furniture-2">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-skateboard.jpg" src="${pageContext.request.contextPath}/images/demo/home-skateboard.jpg" alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-stroller.jpg" src="${pageContext.request.contextPath}/images/demo/home-stroller.jpg" alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-decor.jpg" src="${pageContext.request.contextPath}/images/demo/home-decor.jpg" alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-electronic.jpg" src="${pageContext.request.contextPath}/images/demo/home-electronic.jpg" alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-setup-gear.jpg" src="${pageContext.request.contextPath}/images/demo/home-setup-gear.jpg" alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-dog-accessories.jpg" src="${pageContext.request.contextPath}/images/demo/home-dog-accessories.jpg" alt="home-dog-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-kitchen.jpg" src="${pageContext.request.contextPath}/images/demo/home-kitchen.jpg" alt="home-kitchen-wear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-phonecase.jpg" src="${pageContext.request.contextPath}/images/demo/home-phonecase.jpg" alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home_paddle_board.jpg" src="${pageContext.request.contextPath}/images/demo/home_paddle_board.jpg" alt="home-paddle_board">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-glasses.jpg" src="${pageContext.request.contextPath}/images/demo/home-glasses.jpg" alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-pod-store.jpg" src="${pageContext.request.contextPath}/images/demo/home-pod-store.jpg" alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-activewear.jpg" src="${pageContext.request.contextPath}/images/demo/home-activewear.jpg" alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-handbag.jpg" src="${pageContext.request.contextPath}/images/demo/home-handbag.jpg" alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-tee.jpg" src="${pageContext.request.contextPath}/images/demo/home-tee.jpg" alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-socks.jpg" src="${pageContext.request.contextPath}/images/demo/home-socks.jpg" alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-jewelry.jpg" src="${pageContext.request.contextPath}/images/demo/home-jewelry.jpg" alt="home-jewelry">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-sneaker.jpg" src="${pageContext.request.contextPath}/images/demo/home-sneaker.jpg" alt="home-sneaker">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-accessories.jpg" src="${pageContext.request.contextPath}/images/demo/home-accessories.jpg" alt="home-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-grocery.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-gocery.jpg" src="${pageContext.request.contextPath}/images/demo/home-gocery.jpg" alt="home-grocery">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-baby.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-baby.jpg" src="${pageContext.request.contextPath}/images/demo/home-baby.jpg" alt="home-baby">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-cosmetic.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-cosmetic.png" src="${pageContext.request.contextPath}/images/demo/home-cosmetic.png" alt="home-cosmetic">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-plant.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-plant.png" src="${pageContext.request.contextPath}/images/demo/home-plant.png" alt="home-plant">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-swimwear.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-swimwear.png" src="${pageContext.request.contextPath}/images/demo/home-swimwear.png" alt="home-swimwear">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electric-bike.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-electric-bike.png" src="${pageContext.request.contextPath}/images/demo/home-electric-bike.png" alt="home-electric-bike">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-footwear.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-footwear.jpg" src="${pageContext.request.contextPath}/images/demo/home-footwear.jpg" alt="home-footwear">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-book-store.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-bookstore.png" src="${pageContext.request.contextPath}/images/demo/home-bookstore.png" alt="home-bookstore">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-gaming-accessories.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="${pageContext.request.contextPath}/images/demo/home-gaming-accessories.png" src="${pageContext.request.contextPath}/images/demo/home-gaming-accessories.png" alt="home-gaming-accessories">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="${pageContext.request.contextPath}/images/products/white-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <div class="tf-product-info-price">
                                            ...
                                            <div class="price-on-sale fw-6">$${productDetail.getPrice()}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="${pageContext.request.contextPath}/images/products/white-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <a href="product-detail.html">Mini crossbody bag</a>
                                        <div class="tf-product-info-price">
                                            <div class="price fw-6">$1${productDetail.getPrice()}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="${pageContext.request.contextPath}/images/products/white-1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                ...
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/images/shop/cate/cate1.jpg" alt="">
                            </div>
                    ...
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/images/shop/cate/cate2.jpg" alt="">
                            </div>
                            <span>Dog</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/images/shop/cate/cate3.jpg" alt="">
                            </div>
                            <span>Grocery</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/images/shop/cate/cate4.png" alt="">
                            </div>
                            <span>Handbag</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/images/shop/cate/cate5.jpg" alt="">
                            </div>
                            <span>Fashion</span>
                            <span class="btn-open-sub"></span>
                        </a>
                            ...
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                                        <div class="image">
                                            <img src="${pageContext.request.contextPath}/images/shop/cate/cate6.jpg" alt="">
                                        </div>
                                        <span>Mens</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                    <div id="cate-shop-one" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/shop/cate/cate8.jpg" alt="">
                                                    </div>
                                                    <span>Shoes</span>
                                                </a>
                                            </li>
                                ...
                                <li>
                                    <a href="#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                                        <div class="image">
                                            <img src="${pageContext.request.contextPath}/images/shop/cate/cate9.jpg" alt="">
                                        </div>
                                        <span>Womens</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                    <div id="cate-shop-two" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/shop/cate/cate7.jpg" alt="">
                                                    </div>
                                                    <span>Tee</span>
                                                </a>
                                            </li>
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="${pageContext.request.contextPath}/images/products/orange-1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="${pageContext.request.contextPath}/images/products/pink-1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="wrap">
                    <div class="tf-product-info-item">
                        <div class="image">
                            <img src="${pageContext.request.contextPath}/images/products/orange-1.jpg" alt="">
                        </div>
                        <div class="content">
                            ...
                            <div class="tf-product-info-price">
                                ...
                                <div class="price">$1${productDetail.getPrice()}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tf-product-info-buy-button">
                        <form class="">
                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price">$1${productDetail.getPrice()}</span></a>
                ...
                <div class="wrap">
                    <div class="tf-product-media-wrap">
                        <div dir="ltr" class="swiper tf-single-slide">
                            <div class="swiper-wrapper" >
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="${pageContext.request.contextPath}/images/products/pink-1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tf-product-info-wrap position-relative">
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price">$${productDetail.getPrice()}</span></a>
                                    <a href="javascript:void(0);" class="tf-product-btn-wishlist hover-tooltip box-icon bg_white wishlist btn-icon-action">
                                        <span class="icon icon-heart"></span>
                                        <span class="tooltip">Add to Wishlist</span>
                                        <span class="icon icon-delete"></span>
            ...
            <div class="modal-content">
                ...
                <div class="tf-rte">
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload" data-src="${pageContext.request.contextPath}/images/shop/products/size_chart2.jpg" src="${pageContext.request.contextPath}/images/shop/products/size_chart2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/swiper-bundle.min.js"></script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrap-select.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/drift.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/js/sibforms.js" defer></script>
    ...
    <script type="module" src="${pageContext.request.contextPath}/js/model-viewer.min.js"></script>
    <script type="module" src="${pageContext.request.contextPath}/js/zoom.js"></script>

</body>


<!-- Mirrored from themesflat.co/html/ecomus/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 03:22:32 GMT -->
</html>